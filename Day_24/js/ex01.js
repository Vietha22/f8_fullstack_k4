  ...
  if (inputValue !== "") {
    ...
    task_edit_el.addEventListener("click", (e) => {
      if (
        ...
        task_el.classList.add("br");
        task_actions_el.classList.add("change");
        task_edit_el.innerHTML = "Add Task";
        task_input_el.removeAttribute("readonly");
        task_input_el.focus();
        task_delete_el.innerHTML = "";
      } else {
        task_el.classList.remove("br");
        task_actions_el.classList.remove("change");
        task_edit_el.innerHTML = `<i class="fa-solid fa-pen-to-square"></i>`;
        task_input_el.setAttribute("readonly", "readonly");
        task_delete_el.innerHTML = `<i class="fa-solid fa-trash"></i>`;
